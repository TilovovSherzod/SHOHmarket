...
from mahsulotlar.models import *
...
def login_page(request):
    if request.POST:
        ...
        if user is not None:
            login(request, user)
            return redirect('main_admin_panel')
...
def category_list(request):
    ...
    return render(request, "admin_panel/category/list.html",ctx)
...
def user_list(request):
    ...
    return render(request, "admin_panel/user/list.html",ctx)\
...
def order_list(request):
    ...
    return render(request, "admin_panel/order/list.html",ctx)
...
def user_create(request):
    ...
    return render(request, 'admin_panel/user/form.html',ctx)
...
def category_create(request):
    ...
    return render(request, 'admin_panel/category/form.html',ctx)
...
def product_list(request):
    ...
    return render(request, "admin_panel/product/list.html",ctx)
...
def product_create(request):
    ...
    return render(request, 'admin_panel/product/form.html',ctx)
...
def customer_order_list(request,id):
    ...
    return render(request, "admin_panel/customer_order/list.html", ctx)
...
def orderproduct_list(request,id):
    ...
    return render(request, "admin_panel/productorder/list.html", ctx)